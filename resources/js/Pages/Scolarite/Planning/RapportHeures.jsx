                ...
                <div className="container-fluid">
                    ...
                    {report.length > 0 && (
                        ...
                        >
                            <div className="row">
                                <div className="col-md-12">
                                    <h5>Analyse et suggestions :</h5>
                                    <ul>
                                        {completionRate < 50 && (
                                            <li className="text-danger mb-2">
                                                <strong>Attention :</strong> Le
                                                taux de réalisation global est
                                                inférieur à 50%. Il est
                                                recommandé d'intensifier le
                                                rythme des cours pour rattraper
                                                le retard.
                                            </li>
                                        )}
                                        {completionRate >= 50 &&
                                            completionRate < 80 && (
                                                <li className="text-warning mb-2">
                                                    ...
                                                    satisfaisant mais nécessite
                                                    une surveillance pour
                                                    maintenir le rythme.
                                                </li>
                                            )}
                                        {completionRate >= 80 && (
                                            <li className="text-success mb-2">
                                                <strong>Excellent :</strong> Le
                                        ...
                                        {report.filter((item) => {
                                            ...
                                            <li className="text-danger mb-2">
                                                ...
                                                Certains cours ont un taux de
                                                réalisation très faible (moins
                                                de 30%). Planifiez immédiatement
                                        ...
                                        {remainingHours > 0 && (
                                            <li className="text-info mb-2">
                                                ...
                                                heures à effectuer. Assurez-vous
                                                de les programmer avant la fin
                                                de l'année académique.
                                            </li>
                                        )}
                                        <li className="text-muted mb-2">
                                            <strong>Conseil :</strong> Consultez
                                            régulièrement ce rapport pour
                                            ajuster votre planification et
