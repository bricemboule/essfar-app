...
const programmes = {
    licences: [
        ...
        {
            title: "Informatiques des organisations",
            url: route("formation.informatiques_des_organisations"),
        },
    ],
    masters: [
        { title: "Actuariat", url: route("formation.actuariat") },
        {
            title: "Ingénierie Financière",
            url: route("formation.ingenierie_financiere"),
        },
        {
            title: "Statistique, Big Data et Intelligence Artificielle",
            url: route("formation.big_data"),
        },

        {
            title: "Système d'information",
            url: route("formation.systeme_information"),
        },
    ],
    ...
    Certifications: [
        ...
        {
            title: "CAPITAL MERKET EXECUTIVE CERTIFICATE",
            url: route("formation.mathematiques_economie"),
        },
        {
            ...
            <div className="bg-gradient-to-b from-[#F8F9FA] to-white py-20 px-6">
                ...
                <section className="max-w-6xl mx-auto mb-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        {programmes.licences.map((item, idx) => (
                            <ProgrammeCard
                                key={idx}
                                title={item.title}
                                url={item.url}
                ...
                <section className="max-w-6xl mx-auto mb-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        {programmes.masters.map((item, idx) => (
                            <ProgrammeCard
                                key={idx}
                                title={item.title}
                                url={item.url}
